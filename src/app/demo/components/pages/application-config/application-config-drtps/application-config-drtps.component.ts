...
@Component({
    selector: 'app-application-config-drtps',
    standalone: true,
    imports: [UtilsModuleModule],
    templateUrl: './application-config-drtps.component.html',
    styleUrl: './application-config-drtps.component.scss',
    providers: [ConfirmationService, MessageService],
})
export class ApplicationConfigDrtpsComponent implements OnInit {
